...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  static const _ch = MethodChannel('com.dr.clicker.atikapp/bridge');
  ...
  void initState() {
    ...
    _loadAll();
    _ticker = Timer.periodic(const Duration(seconds: 2), (_) => _refreshStats());
  }
  ...
  void didChangeAppLifecycleState(AppLifecycleState s) {
    if (s == AppLifecycleState.resumed) { _checkA11y(); _refreshStats(); }
  }
  ...
  void _loadAll() {
    ...
    setState(() {
      _master = p.getBool('masterSwitch') ?? false;
  ...
  void _save() {
    ...
    p.setBool('masterSwitch',  _master);
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              if (!_a11yOk) ...[_a11yBanner(), const SizedBox(height: 16)],
              _engineCard(),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('Auto-tap Accept on Rapido & Ola',
                    style: TextStyle(fontSize: 12, color: Colors.grey[500])),
              ],
            ),
          ),
  ...
  Widget _footer() {
    return Center(
      child: Text(
        '⚡ Dr.Clicker v1.0  •  100% Free  •  No Login',
